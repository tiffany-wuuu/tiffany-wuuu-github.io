...
sections:
  ...
  - block: markdown
    content:
      title: Skills (new)
      subtitle: 
      text: Stata ![Stata logo](uploads/laptop.png)<br>Qualitative Analysis<br> Data Collection Large-scale Secondary Datasets Add any **markdown** formatted content here - text, images, videos, galleries - and even HTML code!    
