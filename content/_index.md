...
sections:
  ...
  - block: markdown
    content:
      title: Skills (new)
      subtitle: 
      text: Stata ![Stata logo](uploads/laptop.png)<br>Qualitative Analysis ![Qualitative logo](uploads/qual.png)<br> Data Collection ![People logo](uploads/people128.png)<br> Large-scale Secondary Datasets ![folder image](uploads/folder128.png)Add any **markdown** formatted content here - text, images, videos, galleries - and even HTML code!    
