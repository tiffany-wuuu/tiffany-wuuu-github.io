...
sections:
  ...
  - block: markdown
    content:
      title: Skills (new)
      subtitle: 
      text: Stata ![Stata logo](uploads/stata comp.png)<br>Dedoose<br> Data Collection Large-scale Secondary Datasets Add any **markdown** formatted content here - text, images, videos, galleries - and even HTML code!    
